...
begin
  ...
  c[1, 1] := 0; c[1, 2] := 4; c[1, 3] := 6; c[1, 4] := 3; c[1, 5] := 4;
  c[2, 1] := 5; c[2, 2] := 0; c[2, 3] := 2; c[2, 4] := 5; c[2, 5] := 4;
  c[3, 1] := 9; c[3, 2] := 2; c[3, 3] := 0; c[3, 4] := 2; c[3, 5] := 3;
  c[4, 1] := 3; c[4, 2] := 3; c[4, 3] := 2; c[4, 4] := 0; c[4, 5] := 9;
  c[5, 1] := 1; c[5, 2] := 7; c[5, 3] := 3; c[5, 4] := 2; c[5, 5] := 0;
