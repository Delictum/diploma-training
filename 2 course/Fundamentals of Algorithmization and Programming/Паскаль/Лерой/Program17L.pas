...
begin
  ...
  c[1, 1] := 0; c[1, 2] := 9; c[1, 3] := 12; c[1, 4] := 7; c[1, 5] := 10;
  c[2, 1] := 9; c[2, 2] := 0; c[2, 3] := 7; c[2, 4] := 2; c[2, 5] := 4;
  c[3, 1] := 2; c[3, 2] := 4; c[3, 3] := 0; c[3, 4] := 3; c[3, 5] := 5;
  c[4, 1] := 8; c[4, 2] := 7; c[4, 3] := 1; c[4, 4] := 0; c[4, 5] := 5;
  c[5, 1] := 3; c[5, 2] := 4; c[5, 3] := 3; c[5, 4] := 5; c[5, 5] := 0;
