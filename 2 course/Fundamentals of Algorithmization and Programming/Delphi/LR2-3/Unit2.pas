...
procedure TForm2.Button6Click(Sender: TObject);
    ...
    a : array[1..g,1..g] of integer; // массив
    sum: integer;    // сумма элементов
    sr:    real;    // среднее    арифметическое
    i, j, n , m, k: integer;    // индекс
    begin
...
begin
MediaPlayer1.FileName := 'G:\music\Кардинал.mp3';
MediaPlayer1.Open;
MediaPlayer1.Play;
end;
...
case a of
  ...
  begin
    ...
    1:
  begin
    Shape1.Brush.Color:=clyellow; //Желтый
  end;
    2:
  begin
    Shape1.Brush.Color:=clgreen; //Зеленый
  end;
    3:
  begin
    Shape1.Brush.Color:=clblack; //Черный
  end;
      4:
    begin
