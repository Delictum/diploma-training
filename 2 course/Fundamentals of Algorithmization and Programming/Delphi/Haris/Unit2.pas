...
begin
k:=1;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Йорш - Панк никогда не умрет.mp3';
        mas[1]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Проект Хаос  - Ты - жертва!.mp3';
        mas[2]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Проект Хаос - Абсолютное зло.mp3';
        mas[3]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Bog[]morok - Неизбежность (New_Single_2012).mp3';
        mas[4]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Distemper - Всё или Ничего.mp3';
        mas[5]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\PunKrot - Рок-н-ролльщик (2014).mp3';
        mas[6]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Sex Pistols - Holidays In the Sun.mp3';
        mas[7]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Sex Pistols - No Feelings.mp3';
        mas[8]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Виктор Цой и гр. Кино - Мама анархия.mp3';
        mas[9]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Дай Дарогу - По синему.mp3';
        mas[10]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Йорш - Черный флаг.mp3';
        mas[11]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Кардинал.mp3';
        mas[12]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\ПАРТИЗАНЫ ПАНКА_ Нам Нужна Анархия! - YouTube [720p] (2).wmv';
        mas[13]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\ПАРТИЗАНЫ ПАНКА_ Нам Нужна Анархия! - YouTube [720p].wmv';
        mas[14]:=MediaPlayer1.FileName;
        MediaPlayer1.FileName := 'C:\25 ПОИТ\ОАиП\Delphi\Haris\Win32\Debug\Audio\Большая разница Король и шут.wmv';
