...
begin
  if qw10 = true then
    ball := ball + 1;
  Result.Caption := 'Вы ответили верно на ' + IntToStr(ball);
...
begin
  if (Memo1.Lines[0] = 'Программное')
   and (Memo1.Lines[1] = 'Обеспечение')
    and (Memo1.Lines[2] = 'Информационных')
     and (Memo1.Lines[3] = 'Технологий') then
       ball := ball + 1;
