...
procedure TFormGame3.DBRichEdit2Click(Sender: TObject);
begin
  inc(GameStepID);
  ...
  Otvet := Otvet + sqr(Otvet) + 5;
end;

procedure TFormGame3.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FormBegin.Close;
  LogOut.Close;
end;

procedure TFormGame3.FormShow(Sender: TObject);
begin
  FormGame1.ClientDataSet1.Active := false;
  FormGame1.SQLQuery1.Close;
  FormGame1.SQLQuery1.SQL.Clear;
...
procedure TFormGame3.RichEdit2Click(Sender: TObject);
begin
  FormGame3.Hide;
  FormEnd.Show;
end;
