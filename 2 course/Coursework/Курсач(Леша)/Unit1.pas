...
procedure TFormDinozavr.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Form6.Close;
end;
...
begin
  ShellExecute (FormDinozavr.Handle, nil, 'iexplore', 'https://minenco1998.wixsite.com/mysite', nil, SW_RESTORE);
end;
...
procedure TFormDinozavr.N2Click(Sender: TObject);
begin
  Form5.Show;
end;
