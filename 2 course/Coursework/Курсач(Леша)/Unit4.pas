...
var i: integer;
begin
if edit1.Text='Триас' then Otvet:=Otvet+1;
...
with ListBox4 do
  ...
  if ('Гиганотозавр Гастония Горгозавр Динотиран '=stro4) and ('Арпостал Гномилион Фортазавр Свентанос '=stro3) then Otvet:=Otvet+5;
...
if Otvet<>1 then
label7.Caption:=Label7.Caption+' баллов.'
else
label7.Caption:=Label7.Caption+' балл.';

if (Otvet<=12) and (Otvet>=6) then
begin
label16.Caption:='Ты эрудит.';
end;
if Otvet>12 then
begin
label16.Caption:='Фанатик динозавров.';
end;
if Otvet<6 then
begin
label16.Caption:='Твои знания скудны.';
end;
...
begin
if ('Король и Шут Элизиум Sex Pistols Йорш '=stro4) and ('Distemper Пурген Гражданская оборона Black Flag '=stro3)
then Otvet:=Otvet-5;
PageControl1.ActivePageIndex := 7;
end;
