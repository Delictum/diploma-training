...
begin
  ClientDataSet1.Active := false;
      ...
      if bufName1 = DBLCB3.Text then
        begin
          ShowMessage('Динозавр уже существует.');
          exit;
        end;
      ...
      ShowMessage('Динозавр успешно добавлен.');
end;
...
begin
  ...
  ClientDataSet1.Active := false;
      ...
      if bufID <> Edit4.Text then
        begin
          ShowMessage('Динозавра не существует.');
          exit;
        end;
  ...
  ShowMessage('Динозавр успешно удален.');
end;
...
begin
  ...
  ShowMessage('Динозавр успешно изменен.');
end;
