...
Var bufName1, bufPas1, bufID : string;
    ID : integer;
begin
  if BtnReg.Caption = 'Зарегистрироваться' then
    begin
      if (EditNameLog.Text = '') or (EditNameLog.Text = 'Введите пользователя') then
        begin
          ShowMessage('Введите нового пользователя.');
          exit;
        end;
      ...
      if (EditRPasLog.Text = '') or (EditRPasLog.Text = 'Повторите пароль') then
        begin
  ...
  if BtnReg.Caption = 'Изменить' then
    begin
      if (EditNameLog.Text = '') or (EditNameLog.Text = 'Введите пользователя') then
        begin
          ShowMessage('Введите нового пользователя.');
  ...
  if BtnReg.Caption = 'Удалить' then
    begin
      if (EditPasLog.Text = '') or (EditPasLog.Text = 'Введите пароль') then
        begin
