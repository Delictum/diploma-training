...
begin
form5.Button1.Caption := 'Удалить';
form5.show;
end;

procedure TForm1.Button3Click(Sender: TObject);
begin
form5.Button1.Caption := 'Изменить';
form5.show;
end;
  ...
  ClientDataSet3.Active := false;
   ...
   2: begin
        ClientDataSet1.Active := false;
         SQLQuery1.Close;
          SQLQuery1.SQL.Clear;
          SQLQuery1.SQL.Add(' SELECT параграф FROM paragraf where id=1  ');
          SQLQuery1.Open;
          dbmemo1.DataField:='параграф';
          ClientDataSet1.Active := true;
          ClientDataSet2.Active := false;//вывод задания
         SQLQuery2.Close;
          SQLQuery2.SQL.Clear;
          SQLQuery2.SQL.Add('SELECT задача FROM задания where id_zadanie=0   ');
          SQLQuery2.Open;
          dbmemo2.DataField:='задача';
