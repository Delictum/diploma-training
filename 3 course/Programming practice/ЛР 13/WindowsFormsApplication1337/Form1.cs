...
namespace WindowsFormsApplication1337
{
    public partial class Form1 : Form
    {
        ...
        private HashSet<Journal> JournalList = new HashSet<Journal>();
        ...
        {
            Journal s = new Journal(number, name, redaction, author, price);
        ...
        private void showListInGrid()
        {
            ...
            foreach (Journal s in JournalList)
            {
        ...
        private DataGridViewColumn getDataGridViewColumn2()
        {
            if (dataGridViewColumn2 == null)
            {
                ...
                dataGridViewColumn2.HeaderText = "Название";
        ...
        private DataGridViewColumn getDataGridViewColumn3()
        {
            if (dataGridViewColumn3 == null)
            {
                ...
                dataGridViewColumn3.HeaderText = "Редакция";
        ...
        private DataGridViewColumn getDataGridViewColumn4()
        {
            if (dataGridViewColumn4 == null)
            {
                ...
                dataGridViewColumn4.HeaderText = "Автор";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show("Удалить выделенный журнал?", "",
