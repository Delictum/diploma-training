...
namespace Kurs
{
    public partial class Form6 : Form
    {
        ...
        public int id_Mtelephone = 0;

        public void tabl_Mtelephone()
        {
            try
            {
                connection.Close();
                MySqlDataAdapter adapter = new MySqlDataAdapter("SELECT Mtelephone.id_modelitelephone, Firma.Naimenovanie, Model, Weight, " +
                    "Screen, img FROM Kursach.Mtelephone, Kursach.Firma WHERE Mtelephone.id_firma1 = Firma.id_firma", connection);
                connection.Open();
                ...
                dataGridView1.Columns[4].HeaderText = "Экран";
        ...
        public void LoadFirma()
        {
            try
            {
                adapter = new MySqlDataAdapter("SELECT * FROM Firma", connection);
                connection.Open();
                DataSet ds = new DataSet();
                adapter.Fill(ds, "tabl_Mtelephone");
                comboBox1.DataSource = ds.Tables[0];
                comboBox1.ValueMember = "id_firma";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    adapter = new MySqlDataAdapter("SELECT id_firma FROM Kursach.Firma WHERE Naimenovanie  = '" + comboBox1.Text + "'", connection);
                    connection.Open();
                    DataSet ds = new DataSet();
                    ...
                    command = new MySqlCommand("INSERT INTO Kursach.Mtelephone (id_firma1,Model,Weight,Screen) VALUES (" + temp1 + ", " + textBox1.Text + ", " + textBox2.Text + ", " + textBox3.Text + ")", connection);
                    connection.Open();
            ...
            try
            {
                if (id_Mtelephone != 0)
                    ...
                    else
                    {
                        ...
                        command = new MySqlCommand("UPDATE Kursach.Mtelephone SET id_firma1 = " + temp1 + ", Model = '" + textBox1.Text + "', " +
                            "Weight = '" + textBox2.Text + "', Screen = '" + textBox3.Text + "' WHERE id_modelitelephone = " + id_Mtelephone, connection);
                        connection.Open();
                        command.ExecuteNonQuery();
                        connection.Close();
                        tabl_Mtelephone();
        ...
        private void dataGridView5_Click(object sender, EventArgs e)
        {
            try
            {
                id_Mtelephone = Convert.ToInt32(dataGridView1.CurrentRow.Cells[0].Value);
                comboBox1.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                textBox1.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
                textBox2.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
                textBox3.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();

                if (dataGridView1.Rows[id_Mtelephone].Cells[5].Value != DBNull.Value)
                {
                    MemoryStream image_stream = new MemoryStream((byte[])dataGridView1.Rows[id_Mtelephone].Cells[5].Value);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    command = new MySqlCommand("DELETE FROM Kursach.Mtelephone WHERE id_modelitelephone = '" + id_Mtelephone + "'", connection);
                    connection.Open();
                    command.ExecuteNonQuery();
                    connection.Close();
                    tabl_Mtelephone();
    ...
    ref oMissing, ref oMissing);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            rangeWidth1.EntireColumn.ColumnWidth = 15;
            ...
            rangeWidth5.EntireColumn.ColumnWidth = 13;

            //Шапка таблицы
            Excel1.Range rangeHeader1 = ws_New.get_Range("A5", "E5").Cells;
            ...
            ws_New.Cells[5, 1] = "ID Модели телефона";
            ws_New.Cells[5, 2] = "Название фирмы";
            ws_New.Cells[5, 3] = "Модель";
            ws_New.Cells[5, 4] = "Стоимость";
            ws_New.Cells[5, 5] = "Экран";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                connection.Close();
                MySqlDataAdapter adapter = new MySqlDataAdapter("SELECT Mtelephone.id_modelitelephone, Firma.Naimenovanie, Model, Weight, " +
                    "Screen, img FROM Kursach.Mtelephone, Kursach.Firma WHERE Mtelephone.id_firma1 = Firma.id_firma AND Firma.Naimenovanie='" + textBox4.Text + "'", connection);
                connection.Open();
                DataSet ds = new DataSet();
                adapter.Fill(ds, "Mtelephone");
                dataGridView1.DataSource = ds.Tables["Mtelephone"];
