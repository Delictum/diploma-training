...
namespace WindowsFormsApplication1337
{
    public partial class Form1 : Form
    {
        ...
        private SortedSet<Pribor> PriborList = new SortedSet<Pribor>();
        ...
        private void showListInGrid()
        {
            ...
            foreach (Pribor s in PriborList)
            {
                ...
                cell1.Value = s.getDiapozon();
                cell2.ValueType = typeof(string);
                cell2.Value = s.getPorog();
                cell3.ValueType = typeof(string);
                cell3.Value = s.getChuvstvitelnost();
                cell4.ValueType = typeof(string);
                cell4.Value = s.getTochnost();
                cell5.ValueType = typeof(string);
                cell5.Value = s.getStabilnost();
                row.Cells.Add(cell1);
                row.Cells.Add(cell2);
                row.Cells.Add(cell3);
                row.Cells.Add(cell4);
