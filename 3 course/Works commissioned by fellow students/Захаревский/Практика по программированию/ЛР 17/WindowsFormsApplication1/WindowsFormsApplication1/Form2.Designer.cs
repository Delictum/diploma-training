namespace WindowsFormsApplication1
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Text = "1. Вычислить среднеквадратичное значение четных по значению элементов всего масси" +
    "ва.\n2. Определить наименьший элемент среди каждых третьих элементов второй строк" +
    "и массива";
            // 
            // tabPage2
            // 
            ...
            this.checkBox2.Text = "Наименьший элемент";
            ...
            this.checkBox1.Text = "Среднеквадратичное";
