...
namespace WindowsFormsApplication1337
{
    public partial class Form1 : Form
    {
        ...
        private Stack<Home> JournalList = new Stack<Home>();
        ...
        private void addJournal(string number, string type, string floor, string street, string city)
        {
            Home s = new Home(number, type, floor, street, city);
        ...
        private DataGridViewColumn getDataGridViewColumn1()
        {
            if (dataGridViewColumn1 == null)
            {
                ...
                dataGridViewColumn1.HeaderText = "Номер дома";
        ...
        private DataGridViewColumn getDataGridViewColumn2()
        {
            if (dataGridViewColumn2 == null)
            {
                ...
                dataGridViewColumn2.HeaderText = "Тип";
        ...
        private DataGridViewColumn getDataGridViewColumn3()
        {
            if (dataGridViewColumn3 == null)
            {
                ...
                dataGridViewColumn3.HeaderText = "Количество этажей";
        ...
        private DataGridViewColumn getDataGridViewColumn5()
        {
            if (dataGridViewColumn5 == null)
            {
                ...
                dataGridViewColumn5.HeaderText = "Город";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show("Убрать выделенный дом из таблицы?", "",
