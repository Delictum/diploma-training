object Form1: TForm1
  ...
  object SQLQuery1: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'SELECT report.id, type.name, raipo, report.name, empoyees, profi' +
        't, profit_employee FROM report, type WHERE type.id = report.id L' +
        'IMIT 0, 50')
    SQLConnection = SQLConnection1
    Left = 168
    Top = 584
  ...
  object SQLQuery3: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'SELECT report.id, type.name, raipo, report.name, empoyees, profi' +
        't, profit_employee FROM report, type WHERE type.id = report.id')
    SQLConnection = SQLConnection1
    Left = 608
    Top = 584
  end
