...
begin
    ...
    SQLQuery1.Close;
    SQLQuery1.SQL.Clear;
    SQLQuery1.SQL.Add('SELECT id FROM type WHERE name = "' + DBLookupComboBox1.Text + '"');
    SQLQuery1.Open;
    ...
    SQLQuery1.SQL.Clear;
    SQLQuery1.SQL.Add
      ('INSERT INTO report(id, type_id, raipo, '
      + 'name, empoyees, profit, profit_employee) VALUES (');
    SQLQuery1.SQL.Add(IntToStr(bufId) + ', ' + bufName + ', "' + Edit1.Text +
      '", "' + Edit2.Text + '", ' + Edit3.Text + ', ' + Edit7.Text + ', ' + Edit8.Text + ')');
    SQLQuery1.ExecSQL;
